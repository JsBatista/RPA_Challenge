...
DUMMY_PATHS = [
  r"C:\Users\Batista\Desktop\Algoritmos Aproximativos - Relatório Apresentação.pdf", 
  r"C:\Users\Batista\Desktop\Declaracao Nada Consta.pdf", 
  r"C:\Users\Batista\Desktop\requerimento-de-outorga-de-grau-1a-via.pdf"
  ]

DUMMY_SAVES = [
  r"C:\Users\Batista\Desktop\down\SuperArquivo1.pdf", 
  r"C:\Users\Batista\Desktop\down\SuperArquivo2.pdf", 
  r"C:\Users\Batista\Desktop\down\SuperArquivo3.pdf"
  ]
...
for i in range(0,3):
  ...
  save_as_window.children(control_type="Pane")[0].children(
    title=constants.FILE_NAME_FIELD, 
    control_type="ComboBox"
    )[0].type_keys(DUMMY_SAVES[i])
  ...
  try:
    confirmation_window = find_window(
      app=app, 
